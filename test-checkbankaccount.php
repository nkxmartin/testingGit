...
try {
    ...
    $getouterHTMLBySearchBox = $driver->findElement(
        WebDriverBy::cssSelector('div#filterBar-innerCt table:nth-of-type('. $columnID .') td:nth-of-type(2) input'))->getAttribute('ID');
    ...
    $driver->findElement(
        WebDriverBy::cssSelector('div#filterBar-innerCt table:nth-of-type('. $columnID .') td:nth-of-type(2) input'))
        ->sendKeys('=HSB12345');
